...
Query.Select = function(obj) {
  return new Query('select', obj);
};

// Shortcut function to construct an UPDATE query
Query.Update = function(obj) {
  return new Query('update', obj);
};

// Shortcut function to construct a DELETE query
Query.Delete = function(obj) {
  return new Query('delete', obj);
};

// Shortcut function to construct an INSERT query
Query.Insert = function(obj) {
  return new Query('insert', obj);
};
